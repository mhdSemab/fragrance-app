            ...
            <nav className="bg-white border-b border-gray-100">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                {/* Show Properties link for all users */}
                                <NavLink href={route('properties.index')} active={route().current('properties.*')}>
                                    Properties
                                </NavLink>

                                {/* About page link */}
                                <NavLink href={route('properties.about')} active={route().current('properties.about')}>
                                    About
                                </NavLink>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('properties.about')} active={route().current('properties.about')}>
                            About
                        </ResponsiveNavLink>
                        {user?.roles?.some(role => role.name === 'admin') && (
